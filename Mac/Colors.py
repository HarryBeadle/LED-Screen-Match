...
if platform.startswith('darwin'):
	...
	raise EnviromentError('Unsuported platform.')
print "Found {} serial ports.\n".format(len(working_ports))

# Let the user select their Arduino from a list.
...
serial_port = working_ports[input("Type a port number between 1 and {}: ".format(len(working_ports))) - 1]
